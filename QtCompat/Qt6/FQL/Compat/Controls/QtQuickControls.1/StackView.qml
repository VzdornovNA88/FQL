...
//            __setStatus(enterItem, 1)
//            __setStatus(enterItem, 2)
            return
        }
...
//        __setStatus(__currentTransition.exitItem, 0);
//        __setStatus(__currentTransition.enterItem, 2);
